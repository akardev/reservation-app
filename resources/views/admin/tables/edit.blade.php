        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a class="px-4 py-2 bg-red-700 hover:bg-red-800rounded-lg text-white"
                    href="{{ route('admin.tables.index') }}">Geri Dön</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.tables.update', $table->id) }}"
                        ...
                        <div class="sm:col-span-6">
                            <label for="name" class="block text-sm font-medium text-gray-700"> Masa </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="guestNumber" class="block text-sm font-medium text-gray-700"> Misafir </label>
                            <div class="mt-1">
